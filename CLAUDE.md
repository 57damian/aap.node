...
14. `migracion-ficha-etiqueta.sql` (22/09, ampliada 23/09) — tabla `ficha_etiquetas`, una fila por PDF de etiqueta subido (una ficha puede tener varias; ver "Etiquetas del transformador" abajo). Sin esto no funciona subir ni descargar etiquetas. **Aplicada en local el 23/09/2026 (re-corrida ese día con el diseño de varias etiquetas, reemplaza la versión del 22/09 de una sola columna); falta correrla en Neon.**

...
- **Verificado en vivo de punta a punta**: se cargó una factura de compra de prueba (materia prima "alambre 0,07", proveedor Bignam, $150→$180) y se confirmó que el indicador mostró correctamente "▲ 20.0%", el historial de precios quedó registrado con el proveedor correcto, y el "último precio" global se actualizó.

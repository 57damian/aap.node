...
class FacturasCompra {
    ...
    setupEventListeners() {
        ...
        // Botón para calcular subtotal automáticamente
        document.getElementById('btn-calcular-subtotal').addEventListener('click', () => {
            this.calculateSubtotal();
        });
        
        // Botón para calcular IVA automáticamente
    ...
    onItemFieldChange(event, index, field) {
        ...
        if (field === 'nombre') {
            ...
            item.precio_unitario = parseFloat(value) || 0;
